...
namespace coolpuppy24.rpevents
{
    public class RobFinishCommand : IRocketCommand
    {
        ...
        public void Execute(IRocketPlayer caller, string[] command)
        {
            ...
            {
                UnturnedChat.Say("[RPEvents]: " + Main.Instance.Translate("command_robfinish", caller.DisplayName), UnturnedChat.GetColorFromName(Main.Instance.Configuration.Instance.FinishColor, Color.red));
                return;
            }
